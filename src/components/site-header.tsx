...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-50 px-6 pt-4">
      <div className="relative mx-auto flex h-14 max-w-[60rem] items-center justify-between bg-background/80 px-6 ring-1 ring-foreground/10 backdrop-blur supports-[backdrop-filter]:bg-background/60 2xl:max-w-[75rem]">
        <BlueprintCorners />
