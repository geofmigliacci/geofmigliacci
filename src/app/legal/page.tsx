...
import { contactEmail, host, openGraphBase, person, repoUrl } from "@/lib/site";
...
export const metadata: Metadata = {
  ...
  openGraph: { ...openGraphBase, type: "website", url: "/legal" },
};
...
export default function LegalPage() {
  return (
    <div className="page-shell">
      <JsonLd data={graph(breadcrumbJsonLd("/legal"))} />
