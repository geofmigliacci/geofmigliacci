...
import { contactEmail, host, openGraphBase, person } from "@/lib/site";
...
export const metadata: Metadata = {
  ...
  openGraph: { ...openGraphBase, type: "website", url: "/privacy-policy" },
};
...
export default function PrivacyPolicyPage() {
  return (
    <div className="page-shell">
      <JsonLd data={graph(breadcrumbJsonLd("/privacy-policy"))} />
